    ...
    <v-row class="align-center">
      <v-toolbar app>
            ...
            <v-col class="align-start">
                <v-list nav tile class="d-flex align-start">
...
export default {
     data: () => ({
        ...
        {
            text: 'Care & Rescue',
            sub: 'Care and rescue resources',
            icon: 'mdi-folder',
            subLinks: [
            {
                text: 'Resources',
                sub: 'Various helpful resources',
                icon: '',
                to: '/Resources'
            },
            {
                text: 'Information',
                sub: 'Animal Information',
                icon: '',
                to: '/Information'
            },
            ]
